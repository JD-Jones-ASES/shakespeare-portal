...
**Ten plays fully annotated and shipping**: *Hamlet* (356 annotations, 813-entry glossary), *A Midsummer Night's Dream* (189, 724), *Julius Caesar* (202, 1030), *Romeo and Juliet* (287, 1004), *Richard II* (262, 891), *Henry IV, Part 1* (369, 1044), *Henry IV, Part 2* (291, 1173), *Henry V* (302, 1125), *Henry VI, Part 1* (262, 1093), and *Henry VI, Part 2* (307, 1051) — **2,827 annotations** wired to **86 source-cited reference cards**, every claim through a three-judge fact-check. The six English history plays (Richard II through Henry VI, Part 2) are built around a shared "spine" of reusable historical reference cards (Edward III's sons, the king's two bodies, Holinshed's Chronicles, the great chain of being, trial by combat, the Salic law, Agincourt), extended for the Wars of the Roses (the red-and-white-rose Temple-garden quarrel, Joan la Pucelle, Lord Talbot, Jack Cade's rebellion). Henry V required a gated parser enhancement for its act-by-act Choruses, Induction, and Epilogue; the Henry VI plays needed another for their unbracketed stage directions and separate-line scene settings. The remaining 33 works appear in the catalog as reading texts pending annotation backfill.
