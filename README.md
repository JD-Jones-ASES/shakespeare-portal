...
**Eight plays fully annotated and shipping**: *Hamlet* (356 annotations, 813-entry glossary), *A Midsummer Night's Dream* (189, 724), *Julius Caesar* (202, 1030), *Romeo and Juliet* (287, 1004), *Richard II* (238, 891), *Henry IV, Part 1* (335, 1044), *Henry IV, Part 2* (270, 1173), and *Henry V* (272, 1125) — **2,149 annotations** wired to **76 source-cited reference cards**, every claim through a three-judge fact-check. The four Henriad plays (Richard II through Henry V) are the first English history plays, built around a shared "spine" of reusable historical reference cards (Edward III's sons, the king's two bodies, Holinshed's Chronicles, the great chain of being, trial by combat, the Salic law, Agincourt). Henry V required a gated parser enhancement for its act-by-act Choruses, Induction, and Epilogue, and presents its French scenes with plain-English translation glosses. The remaining 35 works appear in the catalog as reading texts pending annotation backfill.
